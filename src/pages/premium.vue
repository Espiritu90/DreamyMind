<template>
    <div class="wrapper wrapper-flex">
        ...
        <div class="bg-indigo-900 rounded-[32px] flex flex-col align-middle justify-center py-3 px-6">
            ...
            <RouterLink to="/getPremium" class="bg-fuchsia-900 flex justify-center rounded-full align-middle py-3 px-6 text-center text-amber-100 font-semibold">Redeem</RouterLink>
        </div>
    </div>
</template>